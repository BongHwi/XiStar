...
AliXiStarpp13TeVDevel::AliXiStarpp13TeVDevel():
    ...
    fCutList(0),
    htotalEvent(0x0),
    htriggered_INELg0_tracklet(0x0),
    htriggered_CINT7_tracklet(0x0),
    htriggered_CINT7_VOM(0x0),
    htriggered_AliMult_VOM(0x0),
    ...
    fQATPCNcls_p_L(0x0),
    fQATPCNcls_pi1_L(0x0),
    fQATPCNcls_pi2_L(0x0),
    fQATPCNcls_pi3_L(0x0),

    fQATPCNcls_p_T(0x0),
    fQATPCNcls_pi1_T(0x0),
    fQATPCNcls_pi2_T(0x0),
    fQATPCNcls_pi3_T(0x0),
    ...
    fQADCADist_p_L(0x0),
    fQADCADist_pi1_L(0x0),
    fQADCADist_pi2_L(0x0),

    fQADCADist_p_T(0x0),
    fQADCADist_pi1_T(0x0),
    fQADCADist_pi2_T(0x0),

    fDCADist_lambda(0x0),
    fDCADist_3rd_pi(0x0),
    fDCADist_pi_p(0x0),
    fDCADist_pi_lambda(0x0),

    fQADCADist_lambda(0x0),
    fQADCADist_3rd_pi(0x0),
    fQADCADist_pi_p(0x0),
    fQADCADist_pi_lambda(0x0),

    fQADCADist_lambda_L(0x0),
    fQADCADist_3rd_pi_L(0x0),
    fQADCADist_pi_p_L(0x0),
    fQADCADist_pi_lambda_L(0x0),

    fQADCADist_lambda_T(0x0),
    fQADCADist_3rd_pi_T(0x0),
    fQADCADist_pi_p_T(0x0),
    fQADCADist_pi_lambda_T(0x0),

    fCosPA_lambda(0x0),
    fCosPA_Xi(0x0),
    fQACosPA_lambda(0x0),
    fQACosPA_Xi(0x0),
    fQACosPA_lambda_L(0x0),
    fQACosPA_Xi_L(0x0),
    fQACosPA_lambda_T(0x0),
    fQACosPA_Xi_T(0x0),
    hXiInvMass(0x0),
    hQAXiInvMass(0x0),
    ...
    hQATPCNSigProton(0x0),
    hQATPCNSigPion1(0x0),
    hQATPCNSigPion2(0x0),

    hMCinputTotalXiStar1(0x0),
    hMCinputTotalXiStarbar1(0x0),
    hMCinputTotalXi1(0x0),
    hMCinputTotalXibar1(0x0),

    hMCinputTotalXiStar3(0x0),
    hMCinputTotalXiStarbar3(0x0),
    hMCinputTotalXi3(0x0),
    hMCinputTotalXibar3(0x0)
