...
public:
    ...
    AliXiStarpp13TeVDevel();
    AliXiStarpp13TeVDevel(const char *name, Bool_t AODdecision, Bool_t MCdecision, Int_t CutListOption=0, Bool_t DevelopmentMode = kFALSE, Bool_t fHMTrigger = kFALSE, Bool_t fPIDOption = kFALSE);
...
private:
   ...
   // AliInputEventHandler *fEventHandler;                              //  for ESDs or AODs
    ...
    ClassDef(AliXiStarpp13TeVDevel, 10); 
};
