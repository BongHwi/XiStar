...
//________________________________________________________________________
AliXiStarpp::AliXiStarpp(const char *name, Bool_t AODdecision,  Bool_t MCdecision, Int_t CutListOption)
...
//________________________________________________________________________
AliXiStarpp::AliXiStarpp(const AliXiStarpp &obj)
...
void AliXiStarpp::XiStarInit()
{
    ...
    cout<<"AliXiStarpp XiStarInit() call"<<endl;
    ...
    fZvertexBins = 20;
    fMultBins = 11;// This must also be set in AliXiStarpp.h
    ...
    fEC = new AliXiStarppEventCollection **[fZvertexBins];
    for(unsigned short i=0; i<fZvertexBins; i++){
        
        fEC[i] = new AliXiStarppEventCollection *[fMultBins];
        
        for(unsigned short j=0; j<fMultBins; j++){
            
            fEC[i][j] = new AliXiStarppEventCollection(fEventsToMix+1);
        }
    }
    
    fTempStruct = new AliXiStarppTrackStruct[kNbinsM*8];
...
//________________________________________________________________________
void AliXiStarpp::UserCreateOutputObjects()
{
    XiStarInit();
...
//________________________________________________________________________
void AliXiStarpp::Exec(Option_t *)
{
...
//________________________________________________________________________
/*
Double_t AliXiStarpp::LinearPropagateToDCA(AliESDtrack *v, AliESDtrack *t, Double_t b) {// Adapted from AliCascadeVertexer.cxx
    //--------------------------------------------------------------------
...
//________________________________________________________________________
Double_t AliXiStarpp::Det(Double_t a00, Double_t a01, Double_t a10, Double_t a11) const {// Taken from AliCascadeVertexer
    //--------------------------------------------------------------------
...
//________________________________________________________________________
Double_t AliXiStarpp::Det(Double_t a00,Double_t a01,Double_t a02,
