...
class AliXiStarpp : public AliAnalysisTaskSE {
public:
    
    AliXiStarpp();
    AliXiStarpp(const char *name, Bool_t AODdecision, Bool_t MCdecision, Int_t CutListOption=0);
...
private:
   ...
   // AliInputEventHandler *fEventHandler;                              //  for ESDs or AODs
    ...
    AliXiStarppEventCollection ***fEC; //! The event collection
    AliXiStarppEventStruct *fEvt; //! The current event type
    AliXiStarppTrackStruct *fTempStruct; //! A temporary track storage.  Eventually put into fEvt
