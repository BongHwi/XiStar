...
#include "AliXiStarppEventCollection.h"

AliXiStarppTrackStruct::AliXiStarppTrackStruct():
  fStatus(0),
  fFilterMap(0),
  fID(0),
  fPhi(0),
...
AliXiStarppTrackStruct::AliXiStarppTrackStruct(const AliXiStarppTrackStruct &obj) 
  : fStatus(obj.fStatus),
...
//_____________________________________________________________________________
AliXiStarppTrackStruct &AliXiStarppTrackStruct::operator=(const AliXiStarppTrackStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliXiStarppEventStruct::AliXiStarppEventStruct():
  fNTracks(0),
  fTracks(0)
{
  //Default constructor
...
//_____________________________________________________________________________
AliXiStarppEventStruct::AliXiStarppEventStruct(const AliXiStarppEventStruct &obj) 
...
//_____________________________________________________________________________
AliXiStarppEventStruct &AliXiStarppEventStruct::operator=(const AliXiStarppEventStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliXiStarppEventCollection::AliXiStarppEventCollection():
  fFIFO(0),
  fEvtStr(0)
{
//Default constructor
...
//_____________________________________________________________________________
AliXiStarppEventCollection::AliXiStarppEventCollection(short a):
  fFIFO(0),
  fEvtStr(0x0)
{
  // main constructor
  ...
  fEvtStr = new AliXiStarppEventStruct[fFIFO];  //allocate pointer array
...
//_____________________________________________________________________________
AliXiStarppEventCollection::AliXiStarppEventCollection(const AliXiStarppEventCollection &obj) 
  :  fFIFO(obj.fFIFO),
     fEvtStr(obj.fEvtStr)
{
  // copy constructor
...
//_____________________________________________________________________________
AliXiStarppEventCollection &AliXiStarppEventCollection::operator=(const AliXiStarppEventCollection &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
void AliXiStarppEventCollection::FIFOShift(){ //Shift elements in FIFO by one and clear last element in FIFO 
